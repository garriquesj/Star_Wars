...
mv luke_skywalker obi_wan princess_leia.txt chewbacca.txt han_solo.txt /Users/jay/sei/deliverables/Star_Wars/star_wars/empire/death_star
...
mv luke_skywalker leia chewbacca.txt han_solo.txtprincess_leia /Users/jay/sei/deliverables/Star_Wars/star_wars/empire/millenium_falcon
# 4. Move the millenium_falcon back into the rebellion directory.
mv millenium_falcon /Users/jay/sei/deliverables/Star_Wars/star_wars/rebellion
# 5. darth_vader leaves the death_star to pursue luke_skywalker! Move him from the death_star into the empire directory!
mv darth_vader.txt /Users/jay/sei/deliverables/Star_Wars/star_wars/empire
